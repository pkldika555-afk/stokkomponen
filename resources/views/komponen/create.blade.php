                ...
                <div class="px-6 py-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="lokasi" name="lokasi" value="{{ old('lokasi') }}"
                            placeholder="Contoh: Rak A - Laci 3"
                            class="w-full bg-gray-800 border {{ $errors->has('lokasi') ? 'border-rose-500' : 'border-gray-700' }} text-gray-100 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition placeholder-gray-600">
                        @error('lokasi')
                            <p class="mt-1.5 text-xs text-rose-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea id="keterangan" name="keterangan" rows="3"
                            placeholder="Deskripsi tambahan komponen (opsional)..."
                            class="w-full bg-gray-800 border {{ $errors->has('keterangan') ? 'border-rose-500' : 'border-gray-700' }} text-gray-100 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition placeholder-gray-600 resize-none">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <p class="mt-1.5 text-xs text-rose-400">{{ $message }}</p>
                        @enderror
                    </div>
