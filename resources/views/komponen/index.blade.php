                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-gray-800/60 text-xs uppercase tracking-wider text-gray-400">
                            ...
                            <th class="text-right px-6 py-3 font-semibold">Stok</th>
                    ...
                    <tbody class="divide-y divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-800/40 transition-colors duration-150 group">
                            ...
                            <td class="px-6 py-4">
                                <code class="text-xs bg-gray-800 text-indigo-300 px-2 py-1 rounded-md font-mono">{{ $k->kode ?? '-' }}</code>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form action="" method="POST" onsubmit="return confirm('Hapus komponen ini?')">
                                        @csrf @method('DELETE')
                                        <button type="submit"
