    ...
    <div class="min-h-screen bg-gray-950 text-gray-100 font-sans">
        <div class="max-w-2xl mx-auto px-6 py-10">
            ...
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-bold text-white">Tambah Mutasi</h2>
                <p class="text-gray-500 text-sm mt-1">Isi data mutasi yang baru</p>
            </div>
            ...
            <form action="{{ route('komponen.store') }}" method="POST"
                ...
                <div class="px-6 py-5 border-b border-gray-800">
                    <p class="text-sm font-semibold text-gray-200">Informasi Mutasi</p>
