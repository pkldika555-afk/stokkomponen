    ...
    <div class="max-w-xl mx-auto px-6 py-8">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <code class="text-xs font-mono text-indigo-400 bg-gray-900 border border-gray-800 px-3 py-1.5 rounded-lg">
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-2xl p-6 mb-4 text-center">
            ...
            <div class="mt-3">
                <span class="inline-flex items-center px-3 py-1 rounded-lg border text-xs font-medium {{ $jenisColor }}">
                    {{ $mutasi->label_jenis }}
                </span>
            </div>
        </div>
